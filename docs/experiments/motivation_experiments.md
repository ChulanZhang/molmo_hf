...
For detailed documentation on Exp 6, see [vision_tokens_knob.md](../knobs/vision_tokens_knob.md) (crop overlap analysis and vision tokens control).
...
**Detailed Documentation**: See [vision_tokens_knob.md](../knobs/vision_tokens_knob.md) for comprehensive analysis of vision tokens control, crop overlap, and methods to control vision token count.
