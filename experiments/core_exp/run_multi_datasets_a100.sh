...
export DATALOADER_NUM_WORKERS="${DATALOADER_NUM_WORKERS:-2}"  # Reduced from default 4
export DATALOADER_PREFETCH_FACTOR="${DATALOADER_PREFETCH_FACTOR:-1}"  # Reduced from default 2
